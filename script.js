...
//creates the two dots in starting position when page has loaded
...
//this function moves player one
...
//this function creates an alert for the winner
var winner = function() {
	if (currentSpot === 10) {
		alert("Player 1 wins!!!!");
	}
